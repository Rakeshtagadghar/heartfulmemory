    ...
    <main className="mx-auto min-h-screen w-full max-w-3xl px-6 py-16 text-white">
      ...
      <div className="mt-6 space-y-6 rounded-2xl border border-white/10 bg-white/[0.03] p-6 text-sm leading-7 text-white/80">
        <section className="space-y-2">
          ...
          <p>
            Memorioso provides tools to create and manage family storybooks. By using the service, you agree to use it
        ...
        <section className="space-y-2">
          ...
          <p>
            You are responsible for content you upload, record, or share, and for ensuring you have rights to use that
            content. You retain ownership of your story content.
          </p>
        </section>
